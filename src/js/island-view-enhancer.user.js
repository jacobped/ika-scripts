...
(function() {
    ...
    if (!lib) console.warn('Ikariam Island View Enhancer: wait-for-ikariam-model lib not loaded');
    else lib.waitForIkariamModel().then(() => enhanceIslandView());
})();
