...
.dtv-navigation div.active {
    ...
    if (!lib) console.warn('Ikariam Navigation Enhancer: wait-for-ikariam-model lib not loaded');
    else lib.waitForIkariamModel().then(() => new IkariamNavigationEnhancer().init());
})();
